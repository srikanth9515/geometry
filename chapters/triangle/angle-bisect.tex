...
\item Suppose the equations $AB, BC$ and $CA$ are respectively given by 
		...
		\begin{align}
			\frac{\abs{\vec{n}_i^{\top}\vec{x}-c_i}}{\norm{\vec{n}_i}}
		=
...
verify that 
	...
	\item This distance is known as the inradius $r$.
	\item Draw a circle with center $I$ and radius $r$.  This is known as the incentre.
	\item The equation of the incircle is given by 
		\begin{align}
	...
	\item Verify that 
		...
		\end{align}
	\item Obtain $p,q,r$ in terms of $a,b,c$, the sides of the triangle using a matrix equation.  Obtain the numerical values.
\end{enumerate}

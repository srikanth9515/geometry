...
Question: Find the intersection $\vec{G}$ of $BE$ and $CF$
\\ 
\fi
\solution 
...
\vec{G} = \myvec{-2 \\ 0}
\end{align}
From Fig. \ref{fig:Triangle101}, We can see that $\vec{G}=\myvec{-2\\0}$ is the intersection of $BE$ and $CF$
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{solutions/1/2/3/figs/figure.png}

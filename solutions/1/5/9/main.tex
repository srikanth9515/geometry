...
+\norm{\vec{A}}^2-2\brak{\vec{A}^\top\vec{I}}-r^2 &= 0 \label{eq123}
\end{align}
\begin{enumerate}
...
\vec{m} = \vec{A}-\vec{B}
\end{align}
Now putting the values of $\vec{A}, \vec{m}, \vec{I}$ in \eqref{eq123}.
\begin{align}
...
\end{align}
Now putting the values of $\vec{A}, \vec{m}, \vec{I}$ in \ref{eq123}.
\begin{align}

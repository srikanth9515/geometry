...
\end{align}
To find the equations of perpendicular bisectors of $BC$,$AB$,$CA$.\\
\fi
\solution
\begin{enumerate}
\item $BC$:
Given equation for the perpendicular bisector of $BC$:
\begin{align} 
\brak{\vec{x}-\frac{\vec{B}+\vec{C}}{2}}\brak{\vec{B}-\vec{C}}&=0
\end{align}
On substituting the values,
\begin{align}
\vec{\frac{\vec{B}+\vec{C}}{2}} &= \myvec{-\frac{7}{2} \\ \frac{1}{2}}\\
\vec{B}-\vec{C} &= \myvec{-1 \\ 11} 
\end{align}
Solving using matrix multiplication:
\begin{align}
  \brak{\vec{B}-\vec{C}}^\top\brak{\vec{x}-\frac{\vec{B}+\vec{C}}{2}} &=0 \\
  \brak{\vec{B}-\vec{C}}^\top&=\myvec{-1&11}\\
  \brak{\vec{B}-\vec{C}}^{\top}\brak{\frac{\vec{B}+\vec{C}}{2}}\\
  &=\myvec{-1&11}\myvec{-\frac{7}{2} \\ \frac{1}{2}}\\
  &=9
\end{align}
Therefore,perpendicular bisector of $BC$ is
\begin{align}
\myvec{-1&11}\vec{x}&=9
\end{align} 
\item $AB$:
Similar to the equation for the perpendicular bisector of $BC$,
\begin{align}
\vec{\frac{\vec{A}+\vec{B}}{2}}&=\myvec{-\frac{3}{2} \\\frac{5}{2}}\\
\vec{A}-\vec{B}&=\myvec{5\\ -7} \\
\brak{\vec{A}-\vec{B}}^{\top}&=\myvec{5&-7}
\end{align}
Now,
\begin{align}
...
&=-25
\end{align}
Therefore,perpendicular bisector of $AB$ is
\begin{align}
\myvec{5&-7}\vec{x}&=-25
\end{align}    
\item $CA$:
...
&=16
\end{align}
Therefore,perpendicular bisector of $CA$ is
\begin{align}
\myvec{-4&-4}\vec{x}&=16
\end{align}
\begin{figure}
